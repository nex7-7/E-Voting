// This script starts a consensus node that connects to the main mining node
...
async function startConsensusNode() {
  ...
  console.log('Starting consensus node setup...');
  ...
  rl.question('Enter the IP address of the mining node to connect to: ', (miningNodeIp) => {
    ...
    // Start the consensus node with hardhat network (no --network flag)
    // Use a different port than the mining node
    const port = 8546; 
