// This script starts the main mining node that other nodes can connect to
...
async function startMiningNode() {
  ...
  console.log('Starting mining node setup...');
...
function startNodeWithIp(localIp) {
  ...
  // Start the mining node with hardhat network (no --network flag)
  // Hardhat's JSON-RPC server only supports the default hardhat network
